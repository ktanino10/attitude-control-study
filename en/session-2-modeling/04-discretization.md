...
- (In depth) In $`A_d = I_3 + \Delta t\,A`$, what is $`I_3`$?
- (In depth) Why can we say 20 ms is “fast enough before it falls”?

Next: [5. Control law (deciding u = −Kx)](./05-control-law.md)
