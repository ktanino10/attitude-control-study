...
- (In depth) Attitude is what kind of thing from which coordinate frame to which coordinate frame?
- (In depth) About how many degrees is the pitch $`\beta`$ at the corner-standing upright point?

Next: [3. Measuring tilt with an accelerometer](./03-tilt-estimation.md)
