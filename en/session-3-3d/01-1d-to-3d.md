...
- 🔵 How many dimensions does the state vector $`\mathbf{x}`$ have?
- 🔵 What is the newly added “coupling” effect in 3D called?

➡️ Next: [2. Coordinate frames and Euler angles](./02-frames-and-euler.md)
