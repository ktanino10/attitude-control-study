...
| 4 | Photos 2 and 3: sequence from standing up to balancing | Lying down → balancing on an edge → balancing on a vertex | [`session-1-overview/04-jaxa-module.md`](./session-1-overview/04-jaxa-module.md) (figure `standup-sequence.svg`) | 🟢 |
...
| 10 | Fig. 5: control system (system block diagram) | Overall wiring and signal flow centered on PSoC | [`reference/system-block.md`](./reference/system-block.md) | 🟢🔵 |
| 11 | Each interface | Roles of I²C, UART, D-A, pulse counting, MOSFET, and GPIO | [`reference/interfaces.md`](./reference/interfaces.md) | 🟢🔵 |
