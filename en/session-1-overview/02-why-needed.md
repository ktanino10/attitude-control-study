...
| Solar panels | The Sun | No power is generated, so the **battery runs out** |
...
- (In depth) Give two examples of “disturbance torque,” and explain why the system must “keep correcting.”

Next: [3. How to change direction in space](./03-how-to-turn-in-space.md)
