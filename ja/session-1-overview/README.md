...
各ページは **2段階**で書いています。目的に合わせて読み分けてください。

- **やさしく** … 中学生でも分かる"例え"中心。まずここだけ読めば全体像はつかめます。
- **くわしく** … もう少し知りたい人向け。物理の式や電気の理屈で **"なぜそうなるか"** を説明します。むずかしければ飛ばしてOK。

> 「仕組みまで丁寧に理解したい」人は「くわしく」まで、まず流れを掴みたい人は「やさしく」だけ、と選べます。
...
次回予告 [座学2：運動方程式とマイコン制御](../session-2-modeling/README.md)（動きを"式"にして制御する仕組み）
